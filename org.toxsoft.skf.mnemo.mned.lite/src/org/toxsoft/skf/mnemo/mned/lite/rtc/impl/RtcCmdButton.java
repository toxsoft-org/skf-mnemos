...
/**
 * Button that sending command when pressed/unpressed.
 *
 * @author vs
 */
public class RtcCmdButton
    extends AbstractRtControl {

  /**
   * The RtControl factory ID.
   */
  public static final String FACTORY_ID = MNED_LITE + ".rtc.CmdButton"; //$NON-NLS-1$
  ...
  // PARAMID_CATEGORY, CATID_GAUGE//
    ...
    protected void bindViselProps() {
      ...
      bindViselPropId( PROPID_HOVERED_BK_COLOR, PROPID_HOVERED_BK_COLOR );
      bindViselPropId( PROPID_SELECTED_BK_COLOR, PROPID_SELECTED_BK_COLOR );
    }
    ...
    protected IRtControl doCreate( IRtControlCfg aCfg, VedScreen aVedScreen ) {
      ...
      if( v != null && actor != null ) {
        ...
        return new RtcCmdButton( cfg, propDefs(), aVedScreen );
      }
      return null;
    }
  };

  protected RtcCmdButton( IRtControlCfg aConfig, IStridablesList<IDataDef> aPropDefs, VedScreen aVedScreen ) {
