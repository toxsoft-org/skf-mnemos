...
public interface IMnemoEditorPanel {
   ...
   *
   * @return {@link ITsActionHandler} - the handler of the action to be performed externally
   */
  ITsActionHandler externalHandler();
   ...
   */
  void setExternalHandler( ITsActionHandler aHandler );
