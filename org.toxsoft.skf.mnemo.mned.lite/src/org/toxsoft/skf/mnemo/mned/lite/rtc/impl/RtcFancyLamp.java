...
/**
 * Fancy, circle scalable lamp to show boolean value as black color for false and specified color for true.
 * <p>
 *
 * @author vs
 */
public class RtcFancyLamp
    extends AbstractRtControl {

  /**
   * The RtControl factory ID.
   */
  public static final String FACTORY_ID = MNED_LITE + ".rtc.FancyLamp"; //$NON-NLS-1$

  /**
   * The IRtControl factory singleton.
   */
  public static final IRtControlFactory FACTORY = new AbstractRtControlFactory( FACTORY_ID, //
      TSID_NAME, STR_RTC_FANCY_LAMP, //
      TSID_DESCRIPTION, STR_RTC_FANCY_LAMP_D, //
      TSID_ICON_ID, ICONID_RTC_FANCY_LAMP, //
    ...
    protected IRtControl doCreate( IRtControlCfg aCfg, VedScreen aVedScreen ) {
      ...
      if( v != null && actor != null ) {
        ...
        return new RtcFancyLamp( cfg, propDefs(), aVedScreen );
      }
      return null;
    }
  };

  protected RtcFancyLamp( IRtControlCfg aConfig, IStridablesList<IDataDef> aPropDefs, VedScreen aVedScreen ) {
