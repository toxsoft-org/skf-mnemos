...
/**
 * Однострочный текст, отображающий значение РВ данного.
 *
 * @author vs
 */
public class RtcRtdataValueView
    extends AbstractRtControl {

  /**
   * The RtControl factory ID.
   */
  public static final String FACTORY_ID = MNED_LITE + ".rtc.RtdataValueView"; //$NON-NLS-1$

  /**
   * The IRtControl factory singleton.
   */
  public static final IRtControlFactory FACTORY = new AbstractRtControlFactory( FACTORY_ID, //
      TSID_NAME, STR_RTC_RTDATA_VALUE_VIEW, //
      TSID_DESCRIPTION, STR_RTC_RTDATA_VALUE_VIEW_D, //
      TSID_ICON_ID, ICONID_RTC_RTDATA_VALUE_VIEW, //
    ...
    protected IRtControl doCreate( IRtControlCfg aCfg, VedScreen aVedScreen ) {
      ...
      if( v != null && actor != null ) {
        ...
        return new RtcRtdataValueView( cfg, propDefs(), aVedScreen );
      }
      return null;
    }
  };
