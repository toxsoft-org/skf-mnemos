 ...
 * @author vs
 */
public class RtcLabel
    extends AbstractRtControl {

  /**
   * The RtControl factory ID.
   */
  public static final String FACTORY_ID = MNED_LITE + ".rtc.Label"; //$NON-NLS-1$

  /**
   * The IRtControl factory singleton.
   */
  public static final IRtControlFactory FACTORY = new AbstractRtControlFactory( FACTORY_ID, //
      TSID_NAME, STR_RTC_LABEL, //
      TSID_DESCRIPTION, STR_RTC_LABEL_D, //
      TSID_ICON_ID, ICONID_RTC_LABEL, //
      PARAMID_CATEGORY, CATID_TEXT//
  ) {
    ...
    protected IRtControl doCreate( IRtControlCfg aCfg, VedScreen aVedScreen ) {
      ...
      if( v != null ) {
        ...
        return new RtcLabel( cfg, propDefs(), aVedScreen );
      }
      return null;
    }
  ...
  protected RtcLabel( IRtControlCfg aConfig, IStridablesList<IDataDef> aPropDefs, VedScreen aVedScreen ) {
