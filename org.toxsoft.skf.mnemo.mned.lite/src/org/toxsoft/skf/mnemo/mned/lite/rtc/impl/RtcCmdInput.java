...
public class RtcCmdInput
  ...
  public static final IRtControlFactory FACTORY = new AbstractRtControlFactory( FACTORY_ID, //
    ...
    protected ITinTypeInfo doCreateTypeInfo( IStridablesListEdit<ITinFieldInfo> aFields ) {
      ...
      return new PropertableEntitiesTinTypeInfo<>( aFields, RtcCmdInput.class );
    }
    ...
    protected IRtControl doCreate( IRtControlCfg aCfg, VedScreen aVedScreen ) {
      ...
      if( aCfg.viselId().isBlank() ) { // создание с нуля
        ...
        IVedActorFactory af = actorFactory( SkActorCmdField.FACTORY_ID, aVedScreen );
      ...
      if( v != null && actor != null ) {
        ...
        return new RtcCmdInput( cfg, propDefs(), aVedScreen );
      }
      return null;
    }
  };

  protected RtcCmdInput( IRtControlCfg aConfig, IStridablesList<IDataDef> aPropDefs, VedScreen aVedScreen ) {
  ...
  protected void bindActorProps() {
    ...
    bindActorPropId( actor.id(), TFI_CMD_UGWI.id(), TFI_CMD_UGWI.id() );
