...
/**
 * Configuration data of the individual <b>vis</b>ual <b>el</b>ement (VISEL).
 * <p>
 ...
 * @author hazard157
 */
public sealed interface IViselCfg
    extends IStridableParameterized permits ViselCfg {

  /**
   * Returns the ID of the factory used to create the VISEL from the configuration data {@link IViselCfg}.
   * <p>
   ...
   *
   * @return {@link IKeepablesStorage} - arbitrary data
   */
