 ...
 * @author vs
 */
public class ValedRtdataRefbookAttrInfo
    extends AbstractValedTextAndButton<IdChain> {

  /**
   * The factory name.
   */
  public static final String FACTORY_NAME = VALED_EDNAME_PREFIX + ".RtdataRefbookAttrInfoEditor"; //$NON-NLS-1$
  ...
  static class Factory
    ...
    protected IValedControl<IdChain> doCreateEditor( ITsGuiContext aContext ) {
      return new ValedRtdataRefbookAttrInfo( aContext );
    }
  ...
  protected ValedRtdataRefbookAttrInfo( ITsGuiContext aContext ) {
    super( aContext );
  ...
  protected boolean doProcessButtonPress() {
    IdChain result = PanelRtdataRebookAttrInfo.edit( value, tsContext() );
    if( result != null ) {
      value = result;
      return true;
    }
