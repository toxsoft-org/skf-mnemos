...
/**
 * Класс, который разрешает Ugwi с помощью мастер-мастер объекта в Skid.
 * <p>
 * В качестве конфигурационной информации хранит Ugwi класса.
 *
 * @author vs
 */
public class Ugwi2SkidResolver
   ...
   * ИД фабрики
   */
  public static final String FACTORY_ID = "ugwi2SkidResolverFactory"; //$NON-NLS-1$

  private static final IStridablesList<IDataDef> dataDefs = new StridablesList<>( PROP_ATTR_UGWI );
  ...
  public static final ISimpleResolverFactory FACTORY = new AbstractSimpleResolverFactory( //
    ...
    protected AbstractSimpleResolver doCreateResolver( IOptionSet aResolverConfig, ISkConnection aSkConn ) {
      ...
      return new Ugwi2SkidResolver( aResolverConfig, aSkConn );
    }
  };
   ...
   */
  public Ugwi2SkidResolver( IOptionSet aResolverConfig, ISkConnection aSkConn ) {
  ...
  /**
   * Возвращает конфигурацию для {@link Ugwi2SkidResolver}.
   *
   * @param aGwid Gwid - Gwid объекта м.б. абстрактным
   * @return {@link ICompoundResolverConfig} - конфигурацию для {@link Ugwi2SkidResolver}
   */
