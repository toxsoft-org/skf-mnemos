 ...
 * @author vs
 */
public class ValedAvValobjRefbookValuesInfo
    extends AbstractAvWrapperValedControl<IdChain> {

  /**
   * The factory name.
   */
  public static final String FACTORY_NAME = VALED_EDNAME_PREFIX + ".AvRefbookValuesInfo"; //$NON-NLS-1$
  ...
  static class Factory
    ...
    protected IValedControl<IAtomicValue> doCreateEditor( ITsGuiContext aContext ) {
      return new ValedAvValobjRefbookValuesInfo( aContext );
    }
   ...
   */
  public ValedAvValobjRefbookValuesInfo( ITsGuiContext aTsContext ) {
    super( aTsContext, EAtomicType.VALOBJ, ValedRefbookValuesInfo.FACTORY );
  }
