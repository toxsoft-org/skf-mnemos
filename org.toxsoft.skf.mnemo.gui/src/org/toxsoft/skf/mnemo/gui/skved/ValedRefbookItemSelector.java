 ...
 * @author vs
 */
public class ValedRefbookItemSelector
    extends AbstractValedTextAndButton<IdChain> {

  /**
   * The factory name.
   */
  public static final String FACTORY_NAME = VALED_EDNAME_PREFIX + ".RefbookItemSelector"; //$NON-NLS-1$
  ...
  static class Factory
    ...
    protected IValedControl<IdChain> doCreateEditor( ITsGuiContext aContext ) {
      return new ValedRefbookItemSelector( aContext );
    }
  ...
  protected ValedRefbookItemSelector( ITsGuiContext aContext ) {
    super( aContext );
  ...
  protected boolean doProcessButtonPress() {
    IdChain result = PanelRebookItemSelector.edit( value, tsContext() );
    if( result != null ) {
      value = result;
      return true;
    }
